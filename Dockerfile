...
ENV PG_SUPER_PASS C3x{m<p;_!qL-q#g{7`mRQ[>mVy_yk
...
RUN apt-get -qq -y install postgresql-9.3 postgresql-client-9.3 postgresql-contrib-9.3 postgresql-plpython-9.3
